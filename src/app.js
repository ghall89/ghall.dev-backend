...
app.post('/contact', function (c) { return __awaiter(void 0, void 0, void 0, function () {
    var body, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, emailService.sendEmail(body)];
            case 2:
                _a.sent();
            ...
            case 3:
                ...
                return [2 /*return*/, c.json({ error: 'Failed to send email' }, 500)];
